...
case class Quit_3()(val cont: Out[M221_3]) extends InternalChoice2
case class M221_3(msg: String)
case class Quit_4()(val cont: Out[M221_4]) extends InternalChoice3
case class M221_4(msg: String)
case class MonStart()
