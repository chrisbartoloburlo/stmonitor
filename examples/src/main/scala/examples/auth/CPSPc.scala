...
case class Succ(origTok: String)(val cont: Out[InternalChoice1]) extends ExternalChoice2
sealed abstract class InternalChoice1
case class Get(resource: String, reqTok: String)(val cont: Out[ExternalChoice1]) extends InternalChoice1
